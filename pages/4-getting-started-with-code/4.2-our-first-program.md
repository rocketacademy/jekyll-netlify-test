...
Let's run code outside the browser console. We'll create a basic program with a [Coding Basics starter template](https://github.com/rocketacademy/basics-starter-code).

## Setup

`cd` into your `basics/day1/homework` directory.

```bash
cd ~/Documents/basics/day1/homework
```
...
```bash
git clone https://github.com/rocketacademy/basics-starter-code.git <NAME_YOUR_FOLDER>
```

#### Sample:

```bash
git clone https://github.com/rocketacademy/basics-starter-code.git first-program
```
